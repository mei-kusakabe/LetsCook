        ...
        <div className="navbar text-accent">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <li><Link href='/homePage'className='font-semibold'>Home</Link></li>
                    <li><Link href='/about'className='font-semibold'>About Us</Link></li>
                    <li><Link href='/category'className='font-semibold'>Category</Link></li>
                    <li><Link href='/newsletter'className='font-semibold'>Newsletter</Link></li>
